...
class ExampleView(tkinter.Frame):
    def __init__(self, *args, **kwargs):
        tkinter.tk.Frame.__init__(self, *args, **kwargs)
        cbframe = tkinter.tk.Frame(self)
        cb1 = tkinter.tk.Checkbutton(cbframe, text="Choice 1")
        cb2 = tkinter.tk.Checkbutton(cbframe, text="Choice 2")
        cb3 = tkinter.tk.Checkbutton(cbframe, text="Choice 3")
        ...
        e1 = tkinter.tk.Entry(self, width=20)
